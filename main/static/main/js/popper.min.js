...
!function (e, t) {
    ...
    function d(e) {
        ...
        return .5 >= Math.abs(n.width - o) && (o = n.width), .5 >= Math.abs(n.height - r) && (r = n.height), {
            x: e.offsetLeft,
            y: e.offsetTop,
            width: o,
            height: r
    ...
    function y(e) {
        ...
        if (!o) e:{
            for (o = navigator.userAgent.toLowerCase().includes("firefox"), e = m(e); i(e) && 0 > ["html", "body"].indexOf(s(e));) {
                var r = c(e);
                if ("none" !== r.transform || "none" !== r.perspective || "paint" === r.contain || ["transform", "perspective"].includes(r.willChange) || o && "filter" === r.willChange || o && r.filter && "none" !== r.filter) {
                    o = e;
                    break e
                }
                e = e.parentNode
