...
#         self.assertContains(response, 'TweexBook')
...
#         img = models.Product.objects.create(
#             name='The cathedral and the bazaar',
#             slug='cathedral-bazaar',
#             price=Decimal('10.00'),
#         )
#         img.tags.create(name='Open source', slug='opensource')
#         models.Product.objects.create(
#             name='Microsoft Window guide',
...
#     user1 = models.User.objects.create_user('test@user.com', 'test1234')
#     rd = models.Product.objects.create(
...
#     )
#     self.client.force_login(user1)
#     response = self.client.get(reverse('add_to_basket'), {'product_id': rd.id})
#     response = self.client.get(reverse('add_to_basket'), {'product_id': rd.id})
#
...
#
#     response = self.client.get(reverse('add_to_basket'), {'product_id': p.id})
...
#     models.BasketLine.objects.create(basket=basket, product=rd, quantity=2)
#     response = self.client.get(reverse('add_to_basket'), {'product_id': p.id})
#     response = self.client.post(reverse('login'), {'email': 'user1@yaoo.com', 'password': 'test1123'},)
#
